...
typedef struct {
  ...
  pthread_mutex_t  Verrou_signal;          /* Verrou en ecriture pour les champs suivants */
...
void Un_Thread(void){
   ...
   */
  pthread_mutex_lock(&Zone_Part.Verrou_signal);
  pthread_mutex_lock(&Zone_Part.Verrou);
  Zone_Part.Thread_Id = Mon_Tid ;
  Zone_Part.Threads_Finis = Zone_Part.Threads_Finis + 1 ;
