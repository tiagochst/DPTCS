...
% La loi de densité de $(T_1,T_2)$ est donné par:
% \begin{equation}
% f_x(t_1,t_2) = \lambda^2 e^{-\lambda t_2}, si t2>t1>0
% \end{equation}

% La loi de $(T_1,T_2-T_1)$ est donné par:
% \begin{equation}
% P(t_1,t_2-t_1) = \int_0^{t_1}\int_{t_1}^{t_2-t_1} \lambda^2 e^{-\lambda t}dxdt
% \end{equation}
